const api_url = process.env.NEXT_PUBLIC_API_URL || 'https://saavn.dev/api/';
if (!process.env.NEXT_PUBLIC_API_URL) {
    // Fallback to public API if env is not set
    // Consider setting NEXT_PUBLIC_API_URL in .env.local for your own deployment
    console.warn('NEXT_PUBLIC_API_URL not set. Using default https://saavn.dev/api/');
}
